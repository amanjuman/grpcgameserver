...
type MessageToUser struct {
	MsgType MessageToUser_Type `protobuf:"varint,1,opt,name=MsgType,json=msgType,enum=message.MessageToUser_Type" json:"MsgType,omitempty"`
...
type LogMessage struct {
	LogLevel LogMessage_Level `protobuf:"varint,1,opt,name=LogLevel,json=logLevel,enum=message.LogMessage_Level" json:"LogLevel,omitempty"`
	Context  string           `protobuf:"bytes,2,opt,name=Context,json=context" json:"Context,omitempty"`
}
...
type RoomInfo struct {
	...
	Status          RoomInfo_RoomStatus `protobuf:"varint,7,opt,name=Status,json=status,enum=message.RoomInfo_RoomStatus" json:"Status,omitempty"`
...
type SessionInfo struct {
	State    SessionInfo_SessionState    `protobuf:"varint,1,opt,name=State,json=state,enum=message.SessionInfo_SessionState" json:"State,omitempty"`
	Capacity SessionInfo_SessionCapacity `protobuf:"varint,2,opt,name=Capacity,json=capacity,enum=message.SessionInfo_SessionCapacity" json:"Capacity,omitempty"`
...
type ServerInfo struct {
	ServerType      ServerInfo_Type `protobuf:"varint,1,opt,name=ServerType,json=serverType,enum=message.ServerInfo_Type" json:"ServerType,omitempty"`
...
type UserState struct {
	State UserState_UserStatus `protobuf:"varint,1,opt,name=State,json=state,enum=message.UserState_UserStatus" json:"State,omitempty"`
}
...
func init() {
	proto.RegisterType((*Input)(nil), "message.Input")
	proto.RegisterType((*Interaction)(nil), "message.Interaction")
	proto.RegisterType((*EntityState)(nil), "message.EntityState")
	proto.RegisterType((*GameFrame)(nil), "message.GameFrame")
	proto.RegisterType((*Animation)(nil), "message.Animation")
	proto.RegisterType((*Transform)(nil), "message.Transform")
	proto.RegisterType((*SessionCache)(nil), "message.SessionCache")
	proto.RegisterType((*Vector3)(nil), "message.Vector3")
	proto.RegisterType((*Quaternion)(nil), "message.Quaternion")
	...
	proto.RegisterType((*ID)(nil), "message.ID")
	proto.RegisterType((*MessageToUser)(nil), "message.MessageToUser")
	proto.RegisterType((*LogMessage)(nil), "message.LogMessage")
	proto.RegisterType((*FriendRequest)(nil), "message.FriendRequest")
	proto.RegisterType((*SearchKeyWord)(nil), "message.SearchKeyWord")
	proto.RegisterType((*SearchResult)(nil), "message.SearchResult")
	proto.RegisterType((*UserList)(nil), "message.UserList")
	proto.RegisterType((*GameCreation)(nil), "message.GameCreation")
	proto.RegisterType((*PemKey)(nil), "message.PemKey")
	proto.RegisterType((*Empty)(nil), "message.Empty")
	proto.RegisterType((*RoomPrepareView)(nil), "message.RoomPrepareView")
	proto.RegisterType((*EntityInfo)(nil), "message.EntityInfo")
	proto.RegisterType((*Skill)(nil), "message.Skill")
	proto.RegisterType((*HomeView)(nil), "message.HomeView")
	proto.RegisterType((*RoomSetting)(nil), "message.RoomSetting")
	proto.RegisterType((*RoomList)(nil), "message.RoomList")
	proto.RegisterType((*RoomInfo)(nil), "message.RoomInfo")
	proto.RegisterType((*RoomReview)(nil), "message.RoomReview")
	proto.RegisterType((*RoomContent)(nil), "message.RoomContent")
	proto.RegisterType((*PlayerInfo)(nil), "message.PlayerInfo")
	proto.RegisterType((*Character)(nil), "message.Character")
	proto.RegisterType((*SessionInfo)(nil), "message.SessionInfo")
	proto.RegisterType((*Success)(nil), "message.Success")
	proto.RegisterType((*AttrSetting)(nil), "message.AttrSetting")
	proto.RegisterType((*SessionKey)(nil), "message.SessionKey")
	proto.RegisterType((*ServerInfo)(nil), "message.ServerInfo")
	proto.RegisterType((*LoginInput)(nil), "message.LoginInput")
	proto.RegisterType((*RegistInput)(nil), "message.RegistInput")
	proto.RegisterType((*UserInfo)(nil), "message.UserInfo")
	proto.RegisterType((*UserState)(nil), "message.UserState")
	proto.RegisterType((*CharacterSetting)(nil), "message.CharacterSetting")
	proto.RegisterType((*Color)(nil), "message.Color")
	proto.RegisterType((*Equipment)(nil), "message.Equipment")
	proto.RegisterType((*Ability)(nil), "message.Ability")
	proto.RegisterEnum("message.MessageToUser_Type", MessageToUser_Type_name, MessageToUser_Type_value)
	proto.RegisterEnum("message.LogMessage_Level", LogMessage_Level_name, LogMessage_Level_value)
	proto.RegisterEnum("message.RoomInfo_RoomStatus", RoomInfo_RoomStatus_name, RoomInfo_RoomStatus_value)
	proto.RegisterEnum("message.SessionInfo_SessionState", SessionInfo_SessionState_name, SessionInfo_SessionState_value)
	proto.RegisterEnum("message.SessionInfo_SessionCapacity", SessionInfo_SessionCapacity_name, SessionInfo_SessionCapacity_value)
	proto.RegisterEnum("message.ServerInfo_Type", ServerInfo_Type_name, ServerInfo_Type_value)
	proto.RegisterEnum("message.UserState_UserStatus", UserState_UserStatus_name, UserState_UserStatus_value)
}
...
func (c *clientToGameClient) PlayerInput(ctx context.Context, opts ...grpc.CallOption) (ClientToGame_PlayerInputClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_ClientToGame_serviceDesc.Streams[0], c.cc, "/message.ClientToGame/PlayerInput", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *clientToGameClient) UpdateGameFrame(ctx context.Context, in *Empty, opts ...grpc.CallOption) (ClientToGame_UpdateGameFrameClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_ClientToGame_serviceDesc.Streams[1], c.cc, "/message.ClientToGame/UpdateGameFrame", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *clientToGameClient) Pipe(ctx context.Context, opts ...grpc.CallOption) (ClientToGame_PipeClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_ClientToGame_serviceDesc.Streams[2], c.cc, "/message.ClientToGame/Pipe", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *clientToGameClient) TimeCalibrate(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*TimeStamp, error) {
	out := new(TimeStamp)
	err := grpc.Invoke(ctx, "/message.ClientToGame/TimeCalibrate", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ClientToGame_TimeCalibrate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/message.ClientToGame/TimeCalibrate",
	}
...
var _ClientToGame_serviceDesc = grpc.ServiceDesc{
	ServiceName: "message.ClientToGame",
...
func (c *agentToGameClient) AquireGameRoom(ctx context.Context, in *GameCreation, opts ...grpc.CallOption) (*PemKey, error) {
	out := new(PemKey)
	err := grpc.Invoke(ctx, "/message.AgentToGame/AquireGameRoom", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *agentToGameClient) DeletGameRoom(ctx context.Context, in *RoomInfo, opts ...grpc.CallOption) (*Success, error) {
	out := new(Success)
	err := grpc.Invoke(ctx, "/message.AgentToGame/DeletGameRoom", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _AgentToGame_AquireGameRoom_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/message.AgentToGame/AquireGameRoom",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _AgentToGame_DeletGameRoom_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/message.AgentToGame/DeletGameRoom",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _AgentToGame_serviceDesc = grpc.ServiceDesc{
	ServiceName: "message.AgentToGame",
...
func (c *clientToAgentClient) AquireSessionKey(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*SessionKey, error) {
	out := new(SessionKey)
	err := grpc.Invoke(ctx, "/message.ClientToAgent/AquireSessionKey", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *clientToAgentClient) AquireOtherAgent(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*ServerInfo, error) {
	out := new(ServerInfo)
	err := grpc.Invoke(ctx, "/message.ClientToAgent/AquireOtherAgent", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *clientToAgentClient) GetSessionCache(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*SessionCache, error) {
	...
	err := grpc.Invoke(ctx, "/message.ClientToAgent/GetSessionCache", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *clientToAgentClient) Login(ctx context.Context, in *LoginInput, opts ...grpc.CallOption) (*UserInfo, error) {
	out := new(UserInfo)
	err := grpc.Invoke(ctx, "/message.ClientToAgent/Login", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *clientToAgentClient) CreateAccount(ctx context.Context, in *RegistInput, opts ...grpc.CallOption) (*Error, error) {
	out := new(Error)
	err := grpc.Invoke(ctx, "/message.ClientToAgent/CreateAccount", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *clientToAgentClient) SetAccount(ctx context.Context, in *AttrSetting, opts ...grpc.CallOption) (*Success, error) {
	out := new(Success)
	err := grpc.Invoke(ctx, "/message.ClientToAgent/SetAccount", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *clientToAgentClient) SetCharacter(ctx context.Context, in *CharacterSetting, opts ...grpc.CallOption) (*Success, error) {
	out := new(Success)
	err := grpc.Invoke(ctx, "/message.ClientToAgent/SetCharacter", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *clientToAgentClient) AquireGameServer(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*ServerInfo, error) {
	out := new(ServerInfo)
	err := grpc.Invoke(ctx, "/message.ClientToAgent/AquireGameServer", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *clientToAgentClient) CreateRoom(ctx context.Context, in *RoomSetting, opts ...grpc.CallOption) (*Success, error) {
	out := new(Success)
	err := grpc.Invoke(ctx, "/message.ClientToAgent/CreateRoom", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *clientToAgentClient) JoinRoom(ctx context.Context, in *ID, opts ...grpc.CallOption) (*Success, error) {
	out := new(Success)
	err := grpc.Invoke(ctx, "/message.ClientToAgent/JoinRoom", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *clientToAgentClient) RoomReady(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Success, error) {
	out := new(Success)
	err := grpc.Invoke(ctx, "/message.ClientToAgent/RoomReady", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *clientToAgentClient) UpdateRoomContent(ctx context.Context, in *Empty, opts ...grpc.CallOption) (ClientToAgent_UpdateRoomContentClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_ClientToAgent_serviceDesc.Streams[0], c.cc, "/message.ClientToAgent/UpdateRoomContent", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *clientToAgentClient) UpdateHome(ctx context.Context, in *Empty, opts ...grpc.CallOption) (ClientToAgent_UpdateHomeClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_ClientToAgent_serviceDesc.Streams[1], c.cc, "/message.ClientToAgent/UpdateHome", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *clientToAgentClient) UpdateRoomList(ctx context.Context, in *Empty, opts ...grpc.CallOption) (ClientToAgent_UpdateRoomListClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_ClientToAgent_serviceDesc.Streams[2], c.cc, "/message.ClientToAgent/UpdateRoomList", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *clientToAgentClient) UpdateUserList(ctx context.Context, in *Empty, opts ...grpc.CallOption) (ClientToAgent_UpdateUserListClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_ClientToAgent_serviceDesc.Streams[3], c.cc, "/message.ClientToAgent/UpdateUserList", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *clientToAgentClient) Pipe(ctx context.Context, opts ...grpc.CallOption) (ClientToAgent_PipeClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_ClientToAgent_serviceDesc.Streams[4], c.cc, "/message.ClientToAgent/Pipe", opts...)
	if err != nil {
		return nil, err
	}
...
func _ClientToAgent_AquireSessionKey_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/message.ClientToAgent/AquireSessionKey",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ClientToAgent_AquireOtherAgent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/message.ClientToAgent/AquireOtherAgent",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ClientToAgent_GetSessionCache_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/message.ClientToAgent/GetSessionCache",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ClientToAgent_Login_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/message.ClientToAgent/Login",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ClientToAgent_CreateAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/message.ClientToAgent/CreateAccount",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ClientToAgent_SetAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/message.ClientToAgent/SetAccount",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ClientToAgent_SetCharacter_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/message.ClientToAgent/SetCharacter",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ClientToAgent_AquireGameServer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/message.ClientToAgent/AquireGameServer",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ClientToAgent_CreateRoom_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/message.ClientToAgent/CreateRoom",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ClientToAgent_JoinRoom_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/message.ClientToAgent/JoinRoom",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ClientToAgent_RoomReady_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/message.ClientToAgent/RoomReady",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _ClientToAgent_serviceDesc = grpc.ServiceDesc{
	ServiceName: "message.ClientToAgent",
